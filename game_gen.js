...
if (window.location.hostname == 'localhost') {
    base_url = 'http://localhost:8888/gitlab/apistekota/';
}else{
...
function newgame() {
    ...
    $.ajax({
        url: base_url + "index.php/adv/loadgameboard",
        type: "POST",
...
//     let posible_hor, posible_ver;
    
//     clear_highlight_board();
    
//     if (board_set[strarr[1]][strarr[2]] != null && board_set[strarr[1]][strarr[2]] != 0) {
//         //If clicked box has Number
//         findedrootbox = board_set[strarr[1]][strarr[2]];
//         posible_hor = findValue(mendatar_list, findedrootbox);
//         posible_ver = findValue(menurun_list, findedrootbox);

//         //check if theres no possible move on current orientations 
//         if (questorient == 'hor' && posible_hor == null) {
//             questorient = 'ver'     
//         }else if (questorient == 'ver' && posible_ver == null){
//             questorient = 'hor'
//         }

//         //Check if click on same spot | Toggle highlight box
//         if (posible_hor != null && posible_ver != null) {
//             if (activebox == boxtile) {
//                 if (questorient == 'hor') {
//                     questorient = 'ver';
//                 }else{
//                     questorient = 'hor';
...
//         cursorbox = 'anw_' + strarr[1] + '_' + strarr[2];
//         // console.log('cursor bos : ' + cursorbox);
//         highlight_boxes(questorient, findValue((questorient == 'hor' ? mendatar_list : menurun_list), findedrootbox), true, true);
//         cursorposition(cursorbox);
//         //console.log('in here');
//     }else{
//         // Horizontal lookup
//         for (let i = strarr[2]; i >= 0; i--){
//             //Search to left
//             if (!stoplooking){
//                 if (board_set[strarr[1]][i] == null) {
//                     stoplooking = true;
//                 }else{
//                     findedrootbox = board_set[strarr[1]][i];
//                     if (findedrootbox != 0) questorient = 'hor';
//                 }
//             }
//         }
//         // Vertical lookup
//         if (findedrootbox == 0) {
//             stoplooking = false;
//             for (let i = strarr[1]; i >= 0; i--){
//                 //Search to Top
//                 if (!stoplooking){
//                     if (board_set[i][strarr[2]] == null) {
//                         stoplooking = true;
//                     }else{
//                         findedrootbox = board_set[i][strarr[2]];
//                         if (findedrootbox != 0) questorient = 'ver';
//                     }
//                 }
//             }
//         }
...
function gosubmit() {
    ...
    if (!submitrequest) { 
        ...
        uname_active = uname.value;

        var mydata = {
            uname_reg: uname.value,
            idgame: gameid_active,
        };
